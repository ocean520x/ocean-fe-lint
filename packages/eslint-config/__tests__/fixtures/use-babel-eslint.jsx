...
import {
    Breadcrumb, Button, Search, Select, Dropdown, Menu, Notice,
} from "antd";
...
function scoreAudioCoverFile(imgFile) {
    ...
    const relevanceScore = {
        cover: 80, folder: 80, album: 80, front: 80, back: 20, spectrogram: -80,
    };
...
class Root extends Component {
    ...
    render() {
        ...
        const subNavData = {
            navs: [{
                key: "home", text: "导航操作区", active: true, link: "#",
            }, {
                key: "permit", text: "权限", link: "#",
            }, {
                key: "favorite", text: "常用链接", link: "#",
            },],
        };
...
export default connect(({
                            index, ...others
                        }) => ({...index, ...others}), (dispatch) => bindActionCreators(actions, dispatch))(Root);
