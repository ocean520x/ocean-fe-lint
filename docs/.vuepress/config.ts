...
export default defineConfig4CustomTheme({
    ...
    themeConfig: {
        ...
        logo: '/img/logo.png',
        repo: 'ocean520x/ocean-fe-lint',
        searchMaxSuggestions: 10,
        docsDir: 'docs',
        footer: {
            createYear: 2023,
            copyrightInfo:
                'encode studio | <a href="https://github.com/ocean520x/ocean-fe-lint" target="_blank">github</a>',
        },

        extendFrontmatter: {
            author: {
                name: 'ocean',
                link: 'https://github.com/ocean520x/ocean-fe-lint',
            },
        },
    },
